...
escape pod.You're running down the central corridor to the Weapons Armory when
...
space heading to the planet below. As it flies to the planet,
...
the_bridge.add_paths({
    'throw the bmob': generic_death,
    'slowly place the bmob': escape_pod
})
